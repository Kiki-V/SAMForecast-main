...
if __name__ == '__main__':
    ...
    parser.add_argument('--layer_nums', type=int, default=1, help='')
    parser.add_argument('--k', type=int, default=2, help='')
    parser.add_argument('--expert_nums', type=int, default=3, help='')
    parser.add_argument('--wavelets_levels', nargs='+', type=int, default=[3,4,5], help='')
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = '{}_{}_{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_fc{}_eb{}_dt{}_{}_{}_numlayer{}_k{}_wavelet{}'.format(
                args.model_id,
                args.model,
                args.data,
                args.features,
